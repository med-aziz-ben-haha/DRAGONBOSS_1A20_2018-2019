...
void pause(SDL_Surface *screen, int *next, int nb_stage,int *action) // blit background then call pause
{
...
stage[nb_stage-1]=IMG_Load("graphic/stages/bbg1.jpg");

int done=1;
	while (done){
	//affichage des images
	SDL_BlitSurface(stage[nb_stage-1],NULL,screen,&pos);
...
break;
    				...
    				case SDLK_RETURN:
                        ...
                        {options(screen,action,next,&done);
